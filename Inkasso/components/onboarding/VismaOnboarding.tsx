...
interface VismaOnboardingProps {
  onComplete: () => void;
  onSkip?: () => void;
  tenantId?: string | null;
}

const VismaOnboarding: React.FC<VismaOnboardingProps> = ({ onComplete, onSkip, tenantId: propTenantId }) => {
  ...
  const {
    ...
    disconnect,
    clearError,
  } = useVismaIntegration(effectiveTenantId);
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="text-center">
        <div className="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br from-blue-500/20 to-blue-600/10 flex items-center justify-center mb-4">
          <Building2 className="w-8 h-8 text-blue-400" />
        </div>
        <h2 className="text-2xl font-display font-semibold text-white">
          Koppla Visma eAccounting
        </h2>
        <p className="text-gray-400 mt-2">
          Anslut ditt Visma-konto för att automatiskt importera fakturor och kunder
        </p>
      </div>
      ...
      <div className="glass border border-white/10 rounded-xl overflow-hidden">
        {/* Status header */}
        <div className="p-6 bg-gradient-to-br from-blue-500/20 to-blue-600/10 border-b border-white/10">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-display font-semibold text-white">Visma eAccounting</h3>
                <div className="flex items-center gap-1.5 mt-1">
                  {isLoading ? (
                    ...
                    <>
                      ...
                      <span className="text-sm text-blue-400">Ansluten</span>
                    </>
                  ) : (
                    <>
          ...
          {isConnected ? (
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    onClick={onComplete}
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-medium transition-all"
                  >
                    <span>Fortsätt</span>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5">
                ...
                <div>
                  <p className="text-white font-medium">Importera från Visma</p>
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isConnecting ? (
                    <>
                      <Loader2 className="w-5 h-5 animate-spin" />
      ...
      <div className="glass border border-white/10 rounded-xl p-6">
        ...
        <ol className="space-y-3 text-sm text-gray-400">
          <li className="flex gap-3">
            ...
            <span>Klicka på "Koppla till Visma" och logga in på ditt Visma-konto</span>
          </li>
          <li className="flex gap-3">
...
export default VismaOnboarding;

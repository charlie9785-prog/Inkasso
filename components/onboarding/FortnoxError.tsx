...
const FortnoxError: React.FC = () => {
  ...
  const errorInfo = useMemo(() => {
    ...
    const errorMessages: Record<string, { title: string; description: string }> = {
      access_denied: {
        title: 'Åtkomst nekad',
        description: 'Du nekade Zylora åtkomst till ditt Fortnox-konto. För att använda integrationen behöver du godkänna åtkomsten.',
      },
      invalid_request: {
      ...
      unauthorized_client: {
        ...
        description: 'Zylora är inte behörig att ansluta till Fortnox. Kontakta support.',
      },
      server_error: {
        title: 'Serverfel',
        description: 'Ett fel uppstod hos Fortnox. Försök igen om en stund.',
      },
      temporarily_unavailable: {
        title: 'Tillfälligt otillgänglig',
        description: 'Fortnox är tillfälligt otillgänglig. Försök igen om en stund.',
      },
      invalid_scope: {
      ...
      unknown_error: {
        ...
        description: 'Ett oväntat fel uppstod vid anslutning till Fortnox.',
      },
    };

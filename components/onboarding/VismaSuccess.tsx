...
const VismaSuccess: React.FC = () => {
  ...
  const targetUrl = isFromOnboarding ? '/onboarding?visma=success' : '/dashboard';
      ...
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-400 mt-2">
            Ditt Visma eAccounting-konto har kopplats till Zylora. Du kan nu synkronisera fakturor och kunder.
          </p>
        </div>
        ...
        <p className="text-xs text-gray-500">
          Du kan när som helst synkronisera eller koppla bort Visma under Integrationer.
        </p>
      </div>
    </div>
  );
